...
document.getElementById('downloadLetter').addEventListener('click', () => {
  ...
  a.href = url;
  a.download = 'carta_marabella.txt';
...
function startAmbient() {
  ...
  oscB.type = 'sine'; oscB.frequency.value = 114;
  ...
  isPlaying = true;
  audioState.textContent = 'Ambiente: ON';
  toggleAudio.textContent = 'Pausar ambiente';
}
function stopAmbient() {
  ...
  setTimeout(() => {
    ...
    audioState.textContent = 'Silencio';
    toggleAudio.textContent = 'Reproducir ambiente';
  }, 1700);
}
